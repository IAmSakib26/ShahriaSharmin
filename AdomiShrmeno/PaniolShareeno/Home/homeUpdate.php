...
<?php
$sql = "SELECT * FROM com_home_image WHERE HomeImgID=1";
$result = mysqli_query($connEMM, $sql);
						...
						<div id="steps-uid-0" class="wizard clearfix" role="application">
							<div class="content clearfix">
								<section id="steps-uid-0-p-0" class="body current" role="" aria-labelledby="steps-uid-0-h-0" aria-hidden="false">
									<div class="form-group clearfix image-div">
										<div class="col-sm-12" style="padding:15px;">
											<div class="row" style="margin-bottom:10px;">
												<label class="col-sm-2 control-label" for="txtImageBGPath">Home Image: <span>image must be smaller than 3072 KB</span></span></label>
												<div class="col-sm-8">
                                                    <img src="<?php echo (empty($fetch['ImagePath']) ? $sThumb : $sSiteURL.'media/PhotoGallery/'.$fetch['ImagePath'])?>" class="img-fluid img-thumbnail" id="ImageBGPathbtn">
									...
									<div class="form-group clearfix">
										...
										<div class="col-sm-4">
											<input type="text" name="txtCaption" id="txtCaption" class="form-control" value="<?php echo $fetch['Caption']; ?>">
										</div>
									</div>
								</section>
							</div>
							<div class="form-group clearfix">
								<div class="col-lg-12 text-center">
									<input type="submit" name="btnSubmitHome" class="inpSubmit btn-info btn" value="Update">
								</div>
							</div>
						</div>
					</form>
