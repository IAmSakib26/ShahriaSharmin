...
<div class="page-title"><h3 class="title">Dashboard / Category :: List (Bangla)</h3></div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-offset-2 col-sm-8 bg-info text-center"><h4>Category :: List (Bangla)</h4></div>
						...
						<table class="table table-hover table-bordered">
							...
							<thead class="bg-info">
								...
								<tr>
									...
									<th style="width:15%">Priority & Show</th>
