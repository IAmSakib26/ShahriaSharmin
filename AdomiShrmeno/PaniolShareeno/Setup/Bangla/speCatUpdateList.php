...
<title>Special Category :: List (Bangla)</title>
...
<div class="page-title"><h3 class="title">Dashboard / Special Category :: List (Bangla)</h3></div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-offset-2 col-sm-8 bg-info text-center"><h4>Special Category :: List (Bangla)</h4></div>
