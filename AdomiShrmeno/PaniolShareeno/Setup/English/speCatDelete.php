...
<title>Special Category :: Delete (English)</title>
...
<div class="page-title"><h3 class="title">Dashboard / Special Category :: Delete (English)</h3></div>
	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">Special Category :: Delete (English)</h3>
			...
			<div class="panel-body">
				...
				$qDelete="UPDATE en_bas_specialcategory SET Deletable=2 WHERE SpecialCategoryID=".$iDeleteID;
				...
				if(mysqli_query($connEMM, $qDelete)){
					...
					VALUES('".$_SESSION["sessUserName"]."', 3, 'en_bas_specialcategory', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
