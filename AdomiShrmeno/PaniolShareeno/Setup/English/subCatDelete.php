	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				$qDelete="UPDATE en_bas_subcategory SET Deletable=2 WHERE SubCategoryID=".$iDeleteID;
				...
				if(mysqli_query($connEMM, $qDelete)){
					...
					VALUES('".$_SESSION["sessUserName"]."', 3, 'en_bas_subcategory', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
