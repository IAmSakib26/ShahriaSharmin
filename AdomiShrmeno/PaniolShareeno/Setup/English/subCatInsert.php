	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php $resultCategory=mysqli_query($connEMM, "SELECT CategoryID, CategoryName FROM en_bas_category WHERE Deletable=1 ORDER BY CategoryName") or die(mysqli_error($connEMM)); ?>
