	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				$qUpdate="SELECT * FROM en_bas_subcategory WHERE SubCategoryID=".$iUpdateID;

				$resultUpdate=mysqli_query($connEMM, $qUpdate);

				$rsUpdate=mysqli_fetch_assoc($resultUpdate);

				$resultCategory=mysqli_query($connEMM, "SELECT CategoryID, CategoryName FROM en_bas_category WHERE Deletable=1 ORDER BY CategoryName") or die(mysqli_error($connEMM)); ?>
							...
							<section id="steps-uid-0-p-0" class="body current" role="" aria-labelledby="steps-uid-0-h-0" aria-hidden="false">
								...
								<div class="form-group clearfix">
									...
									<div class="col-sm-7">
										...
										<input type="text" id="txtSubCategoryName" name="txtSubCategoryName" maxlength="100" class="form-control" value="<?php echo $rsUpdate["SubCategoryName"]; ?>" required autofocus>
								...
								<div class="form-group clearfix">
									...
									<div class="col-sm-10">
										...
										<textarea name="txtRemarks"><?php echo $rsUpdate["Remarks"]; ?></textarea>
