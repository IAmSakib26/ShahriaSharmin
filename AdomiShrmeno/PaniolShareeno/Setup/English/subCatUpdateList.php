...
<title>Sub-Category :: List (English)</title>
...
<div class="page-title"><h3 class="title">Dashboard / Sub-Category :: List (English)</h3></div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-offset-2 col-sm-8 bg-info text-center"><h4>Sub-Category :: List (English)</h4></div>
					...
					<div class="col-sm-12 DTable table-responsive">
						...
						<table class="table table-hover table-bordered">
							...
							<tbody>
								...
								<?php $resultCategory=mysqli_query($connEMM, "SELECT en_bas_subcategory.*, en_bas_category.CategoryName FROM en_bas_subcategory INNER JOIN en_bas_category ON en_bas_category.CategoryID=en_bas_subcategory.CategoryID WHERE en_bas_subcategory.Deletable=1 ORDER BY en_bas_subcategory.SubCategoryID") or die(mysqli_error($connEMM));

								while($rsCategory=mysqli_fetch_assoc($resultCategory)){ ?>

								<tr>

									<td><?php echo $rsCategory["SubCategoryID"]; ?></td>
