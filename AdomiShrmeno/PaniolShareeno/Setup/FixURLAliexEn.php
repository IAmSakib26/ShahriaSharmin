	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<center><p>Total unsolved URL: <?php
				...
				$qCount='SELECT COUNT(ContentID) AS TotalBlank FROM en_content WHERE URLAlies IS NULL';
			...
			<div class="panel-body">
				...
				<form id="frmInsert" name="frmInsert" method="post" action="FixURLAliexEn.php">
								...
								<div class="col-sm-12 DTable table-responsive">
									...
									<div class="form-group clearfix">
										...
										<div class="col-sm-3">
											...
											<input type="text" name="txtContentIDFrom" maxlength="10" value="1" class="form-control required">
										...
										<div class="col-sm-3">
											...
											<input  type="text" name="txtContentIDTo" maxlength="10" value="1000" class="form-control required">
			...
			if(isset($_REQUEST["btnSubmit"])){
				...
				$qShow='SELECT ContentID, ContentHeading FROM en_content WHERE URLAlies IS NULL ORDER BY ContentID ASC LIMIT '.$iContentIDFrom.', '.$iContentIDTo;
				...
				if(mysqli_num_rows($resultShow)>0){
					...
					$qUpdate="UPDATE en_content SET URLAlies='".$sContentHeading."' WHERE ContentID=".$iContentID;
