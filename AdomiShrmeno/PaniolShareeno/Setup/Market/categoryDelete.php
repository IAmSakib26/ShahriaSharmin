	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				$qDelete="UPDATE com_market_category SET Deletable=2 WHERE CategoryID=".$iDeleteID;
				...
				if(mysqli_query($connEMM, $qDelete)){
					...
					VALUES('".$_SESSION["sessUserName"]."', 3, 'com_market_category', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
