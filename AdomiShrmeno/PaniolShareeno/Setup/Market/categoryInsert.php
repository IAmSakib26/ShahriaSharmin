...
<title>Category :: Insert (Market)</title>
...
<div class="page-title"><h3 class="title">Dashboard / Category :: Insert (Market)</h3></div>
	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">Category :: Insert (Market)</h3>
						...
						<section id="steps-uid-0-p-0" class="body current" role="" aria-labelledby="steps-uid-0-h-0" aria-hidden="false">
                            ...
                            <div class="form-group clearfix">
								...
								<div class="col-sm-7">
									...
									<input type="text" id="txtCategoryNameBN" name="txtCategoryNameBN" maxlength="100" class="form-control" value="" required autofocus>
