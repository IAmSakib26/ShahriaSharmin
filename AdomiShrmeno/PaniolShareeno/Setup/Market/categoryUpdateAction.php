		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				if(isset($_POST["btnSubmit"])){
					...
					$qUpdate="UPDATE com_market_category SET
					CategoryName='".$sCategoryName."',
					CategoryNameBN='".$sCategoryNameBN."',
					Slug='".$sSlug."',
					EndNote='".$sEndNote."',
					Remarks='".$sRemarks."',";
					...
					if(mysqli_query($connEMM, $qUpdate)){
						...
						VALUES('".$_SESSION["sessUserName"]."', 2, 'com_market_category', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qUpdate)."', '".$dtDateTime."')";
								...
								while($fileRen=readdir($dir)){
									if($fileRen==$sImagePathIcon){
										...
										if($iFlag==1){
											...
											$qUpdate="UPDATE com_market_category SET ImagePathIcon='".$sNewName."' WHERE CategoryID=".$iUpdateID;
											//echo $qUpdate."<br>";
