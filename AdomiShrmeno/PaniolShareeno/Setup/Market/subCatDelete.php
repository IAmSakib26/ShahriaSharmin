...
<title>Sub-Category :: Delete (English)</title>
...
<div class="page-title"><h3 class="title">Dashboard / Sub-Category :: Delete (English)</h3></div>
	...
	<div class="col-sm-12 DPaddingLR">
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">Sub-Category :: Delete (English)</h3>
			...
			<div class="panel-body">
				...
				$qDelete="UPDATE com_market_subcategory SET Deletable=2 WHERE SubCategoryID=".$iDeleteID;
				...
				if(mysqli_query($connEMM, $qDelete)){
					...
					VALUES('".$_SESSION["sessUserName"]."', 3, 'com_market_subcategory', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
