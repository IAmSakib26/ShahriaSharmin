					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							if(isset($_POST["btnSubmit"])){
								$UserName=""; $UserType="";	$sWriterName="";$sWriterNameEn="";	$InitialBn="";	$InitialEn="";	$sWriterBio="";	$sWriterBioEn=""; $sSlug="";
								...
								$sWriterName=fFormatString($_POST["txtWriterName"]);
								$InitialBn=fFormatString($_POST["txtInitialBn"]);
								...
								$qInsert="INSERT INTO bn_writer(Type, WriterName, InitialBn, Slug, WriterBio, ImagePath, DateTimeInserted) 
								VALUES(".$UserType.", '".$sWriterName."', '".$InitialBn."', '".$sSlug."', '".$sWriterBio."', '".$sImageSMPathNew."', '".$dtDateTime."')";
								//echo $qInsert."<br><br>";
								...
								if(isset($resultInsert)){
												...
												while($fileRen=readdir($dir)){
													if($fileRen==$sImageSMPath){
														...
														if($iFlag==1){
															...
															$sNewName=$sNewName;
															$qUpdate="UPDATE bn_writer SET ImagePath='".$sNewName."' WHERE WriterID=".$iThisContentID;
									...
									echo $sMsgInsert;
									header("Location: writerInsert.php");
								}else{
									echo $sMsgInsertFail;
								}
							} ?>
