...
<div id="wrapper" class="toggled">
	...
	<div id="page-content-wrapper">
		...
		<div class="container-fluid">
			...
			$resultSQL=mysqli_query($connEMM, "SELECT ContentID, ContentSubHeading, ContentHeading, URLAlies FROM en_content WHERE Deletable=1 AND ShowContent=1 ORDER BY ContentID DESC LIMIT 50");
			...
			$myFile=$UploadXHTML_EN."liLatestNews.htm";

			$fh=fopen($myFile, "w");fwrite($fh, $sData);fclose($fh);?>

			<!-- Message alert after generating Top 50 content (English) news-->

			<div class="page-title">

				<h3 class="title"><?php echo "Top 50 content (English) generated"; ?></h3>
