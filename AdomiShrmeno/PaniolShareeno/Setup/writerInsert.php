...
<title>Dashboard / Writer - Insert</title>
...
<div class="col-sm-offset-9 text-center">
	<a href="<?php echo $sAdmnURL; ?>Setup/writerList.php"><button type="button" class="btn btn-info">Writer List</button></a>
</div><br>
<div class="row">
	<div class="col-sm-12 DPaddingLR">
		<div class="panel panel-default">
			<div class="panel-body">
				<form name="frmInsert" method="post" action="WriterInsertAction.php" enctype="multipart/form-data">
						...
						<div class="content clearfix">
							<section id="steps-uid-0-p-0" class="body current" role="" aria-labelledby="steps-uid-0-h-0" aria-hidden="false">
								...
								<div class="form-group clearfix">
									...
									<div class="col-sm-10">
										<input type="text" id="txtWriterName" name="txtWriterName" maxlength="100" value="" class="form-control">
									</div>
								</div>
								<div class="form-group clearfix">
									<label class="col-sm-2 control-label" for="#"> Initial (BN): </label>
									<div class="col-sm-4">
										<input type="text" id="txtInitialBn" name="txtInitialBn" maxlength="10" value="" class="form-control">
									</div>
								...
								<div class="form-group clearfix">
									<label class="col-sm-2 control-label" for="#">Writer Bio (BN): </label>
									<div class="col-sm-10">
