	...
	<div class="col-sm-12 DPaddingLR">
		<div class="panel panel-default">
		        <div class="col-sm-offset-9 text-center">
					<a href="<?php echo $sAdmnURL; ?>Setup/writerInsert.php"><button type="button" class="btn btn-info">Add Writer</button></a>
				</div>
				...
				<div class="row">
					<div class="col-sm-12 DTable table-responsive">
						<table class="table table-hover table-bordered">
							...
							<tbody>
								<?php $resultWriter=mysqli_query($connEMM, "SELECT WriterID, WriterName, WriterNameEn, WriterBio, WriterBioEn, ImagePath, Deletable FROM bn_writer ORDER BY WriterID DESC LIMIT 500") or die(mysqli_error($connEMM));
								while($rsWriter=mysqli_fetch_assoc($resultWriter)){ ?>
								<tr>
									<td><?php echo $rsWriter["WriterName"].$rsWriter["WriterNameEn"]; ?></td>
									<td><?php echo $rsWriter["WriterBio"].$rsWriter["WriterBioEn"]; ?></td>
									...
									<td><a href="writerUpdate.php?updateid=<?php echo $rsWriter["WriterID"]; ?>"><button type="button" class="btn btn-info">Update</button></a></td>
									<td>
