...
<div class="container-fluid">
	...
	<div class="page-title"><h3 class="title">Dashboard / Photo Insert</h3></div>
	<div class="row">
		<div class="col-sm-12 DPaddingLR">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Photo - Insert </h3>
						...
						<div id="steps-uid-0" class="wizard clearfix" role="application">
							<div class="content clearfix">
								<section id="steps-uid-0-p-0" class="body current" role="" aria-labelledby="steps-uid-0-h-0" aria-hidden="false">
									...
									<div class="form-group clearfix">
										...
										<div class="col-sm-4">
											<input type="number" step="any" name="txtWidth" class="form-control" id="txtWidth" min="1">
										</div>
										<label class="col-sm-2 control-label " for="txtHeight">Image Height(px): </label>
										<div class="col-sm-4">
											<input type="number" step="any" name="txtHeight" class="form-control" id="txtHeight" min="1">
										</div>
									</div>
									<div class="form-group clearfix">
										<label class="col-sm-2 control-label " for="txtimgorvid">Image or Video?:</label>
										<div class="col-sm-2">
											<input type="radio" name="txtimgorvid" value="1" class="form-check image" checked> Image
										</div>
										<div class="col-sm-2">
											<input type="radio" name="txtimgorvid" value="2" class="form-check video"> Video
										</div>
									</div>
									<div class="form-group clearfix">
										<label class="col-sm-2 control-label " for="txtGap">Gap After Image?:</label>
										<div class="col-sm-2">
											<input type="radio" name="txtGap" value="1" class="form-check"> Yes
										</div>
										<div class="col-sm-2">
											<input type="radio" name="txtGap" value="2" class="form-check" checked> No
										</div>
									</div>
									<div class="form-group clearfix image-div">
										<div class="col-sm-12" style="padding:15px;">
											<div class="row" style="margin-bottom:10px;">
												<label class="col-sm-2 control-label" for="txtImageBGPath">Album Image: <span>image must be smaller than 3072 KB</span></span></label>
												<div class="col-sm-8">
												<img src="<?=$sThumb?>" class="img-fluid img-thumbnail" id="ImageBGPathbtn">
									...
									<div class="form-group clearfix video-div">
										<div class="col-sm-12" style="padding:15px;">
											<div class="row" style="margin-bottom:10px;">
												...
												<div class="col-sm-8">
													<input type="file" name="txtVideoath" id="txtVideoath" class="form-control">
									...
									<div class="form-group clearfix">
										...
										<div class="col-sm-4">
											<input type="text" name="txtCaption" id="txtCaption" class="form-control required" required>
										</div>
									</div>
								</section>
							</div>
							<div class="form-group clearfix">
								<div class="col-lg-12 text-center">
									<input type="submit" name="btnSubmitFoto" class="inpSubmit btn-info btn" value="Insert" id="submitit">
								</div>
							</div>
						</div>
					</form>
...
$(document).ready(function(){
	...
	$.get('loadAlbm.php',function(data){
